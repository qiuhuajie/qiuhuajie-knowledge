...
2. **Redisson**
    ...
    ![[IMG-20260620224127759.png|739]]

3. 官网地址：
    > ℹ️ Redisson: Redis Java client with features of In-Memory Data Grid
    > Redis Java client with features of In-Memory Data Grid.
    > [https://redisson.org/](https://redisson.org/)
4. GitHub地址：
    > ℹ️ GitHub - redisson/redisson: Redisson - Redis Java client with features of In-Memory Data Grid. Over 50 Redis based Java objects and services: Set, Multimap, SortedSet, Map, List, Queue, Deque, Semaphore, Lock, AtomicLong, Map Reduce, Publish / Subscribe, Bloom filter, Spring Cache, Tomcat, Scheduler, JCache API, Hibernate, MyBatis, RPC, local cache ...
...
5. ==**实际开发中，并不需要自定义分布式锁，直接调用 Redisson 即可**==
