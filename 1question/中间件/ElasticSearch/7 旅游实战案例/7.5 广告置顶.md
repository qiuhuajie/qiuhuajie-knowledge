...
1. 让指定的酒店在搜索结果中排名置顶
2. 我们给需要置顶的酒店文档==添加一个标记==。然后==利用function score给带有标记的文档增加权重==
3. 实现步骤分析：
    ...
    ![[IMG-20260620224143012.png|437]]
    ![[IMG-20260620224153244.png|800]]
...
4. 测试：
    ...
    ![[IMG-20260620224201535.png|800]]
    2. 效果：

    ![[IMG-20260620224207872.png|800]]
