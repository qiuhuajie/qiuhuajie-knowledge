1. **原生的 Java API 分布式开发存在的问题**
    ...
    1. Watch 需要重复注册，不然就不能生效
    
    1. 开发的复杂性还是比较高的
    
    1. 不支持多节点删除和创建。需要自己去递归
    
1. Curator 是一个专门解决分布式锁的框架，解决了原生 Java API 开发分布式遇到的问题
...
1. Curator 案例实操
    ...
    1. 测试结果：
        ...
        ![[Attachment/1question/中间件/ZooKeeper/实践案例/分布式锁/IMG-20260405035438371.png|Untitled 450.png]]