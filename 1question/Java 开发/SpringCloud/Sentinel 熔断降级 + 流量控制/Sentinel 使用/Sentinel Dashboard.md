...
1. 访问 [http://localhost:8080/](http://localhost:8080/) （sentinel dashboard 端口是 8080），登录账号密码均为sentinel
    
    ![[IMG-20260405035414038.png|Untitled 504.png]]
...
1. **yaml 配置文件：spring.cloud.sentinel**
...
1. 启动 cloudalibaba-sentinel-service8401
1. Sentinel采用的**懒加载**，需要先访问请求，才能监控到
...
1. [http://localhost:8080/](http://localhost:8080/)
    ...
    1. ==**簇点链路：**==
        ...
        ![[IMG-20260404031843445.png|Untitled 1 371.png]]
    ...
    1. ==**实时监控：**==
        ...
        ![[IMG-20260405035420394.png|Untitled 2 301.png]]