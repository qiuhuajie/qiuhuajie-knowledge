1. **静态资源目录**
    ...
    1. 只要静态资源放在类路径下： called `**/static**` (or `**/public**` or `**/resources**` or `**/META-INF/resources**`
        ...
        ![[IMG-20260404031830423.png|Untitled 481.png]]
        
    
    1. 访问 ： ==**当前项目根路径/ + 静态资源名**==（静态资源只要放在上面的目录里就可以访问到了）
        
        ![[IMG-20260404031830479.jpeg|Untitled 22.jpeg]]
        
    
1. 原理： 静态映射 /**
1. 如果 有一个 **动态请求** 也是`**/1.jpg**` 那么会优先访问动态请求
    ...
    ![[IMG-20260405035420372.jpeg|Untitled 1 7.jpeg]]
    
1. **静态资源的访问流程**
    
    1. 请求进来，先去找 Controller 看能不能处理
    
    1. 不能处理的所有请求又都交给静态资源处理器
    
    1. 静态资源也找不到则响应404页面
    
1. **为了避免和动态请求的同名冲突：静态资源访问前缀**
...
1. **也可改变默认的静态资源的目录**
    ...
    1. 访问：5.jpg 当前在 /abc/ 目录下存放
        
        ![[IMG-20260405035422097.png|Untitled 1 352.png]]
        
    
    1. 官方文档里明确说了是 替换 默认静态资源目录
