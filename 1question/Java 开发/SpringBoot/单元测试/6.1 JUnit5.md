...
3. **JUnit 5 = JUnit Platform + JUnit Jupiter + JUnit Vintage**
    ...
    ![[IMG-20260405035413878.png|800]]

    4. 注意：
        1. **SpringBoot 2.4 以上版本移除了默认对 Vintage 的依赖**
        2. **JUnit 5’s Vintage Engine Removed from spring-boot-starter-test，如果需要继续兼容junit4需要自行引入vintage**
    ...
    ```
4. SpringBoot 2 会自动生成一个 junit 5 测试类

    ![[IMG-20260404031836533.png|800]]

    且会自动引入的测试依赖

![[IMG-20260405035420276.png|578]]
