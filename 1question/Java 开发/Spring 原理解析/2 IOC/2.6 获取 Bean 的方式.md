...
# 1. 介绍
- 获取 Bean 的原理：`.getBean("xxx")` ，==利用==**==反射机制==**==，根据这个字符串获得某个类的 Class 实例==[[Export-e8249ac1-4ae1-42cd-83d5-041a266841fe/1question/Java 开发/Java/反射|反射]]
- **一共七种方式**
...
1. 同时**也是常用的获取 `WebApplicationContext` 的一种方法**
1. ==这个方法常见于SpringMVC实现的web项目中==
1. 代码示例：
